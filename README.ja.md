...
| フェーズ | 機能 | 状態 |
|---------|------|------|
| Phase 1 (MVP) | AI 検索、AI 要約、タブ、履歴、ショートカット、ダークモード、設定、SQLite、GitHub 認証 | **完了** (11/11) |
| Phase 2 | コード Q&A、ブックマーク、コレクション、ヘルススコア、比較、スマートフォルダ、コードビューアー、フィルター | **完了** (9/9) |
| Phase 3 | ローカル AI (Ollama)、オフラインモード、トレンドダッシュボード、エクスポート、自動アップデート、キャッシュ | **完了** (8/8) |

---

## セキュリティ

- API キーは **お使いのパソコンにのみ** ローカル保存されます（SQLite データベース）
