    ...
    <div style={{ position: 'relative' }} ref={panelRef}>
      ...
      {isOpen && (
        <div style={{
            ...
            <div style={{ display: 'flex', gap: 6 }}>
              {activeCount > 0 && (
                <button
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: 4, fontSize: 11, color: 'var(--text-tertiary)', background: 'none', border: 'none', cursor: 'pointer' }}
                >
          ...
          <div style={{ height: 1, background: 'var(--border)', margin: '0 -20px', marginBottom: 16 }} />
