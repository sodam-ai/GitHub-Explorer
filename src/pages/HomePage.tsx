    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6">
      ...
      >
        {SUGGESTIONS.map((s, i) => (
          <motion.button
            ...
            className="btn btn-outline text-[12px] gap-1.5 py-1.5 px-3.5"
          >
      ...
      {searchHistory.length > 0 && (
        ...
        >
          ...
          <div className="border border-[var(--border)] rounded-xl bg-[var(--bg-card)] overflow-hidden shadow-[var(--shadow-sm)]">
            {searchHistory.slice(0, 4).map((h, i) => (
              <motion.button
                ...
                className={`w-full flex items-center justify-between px-4 py-3 hover:bg-[var(--bg-secondary)] transition-colors group text-left ${
